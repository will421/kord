...
class DefaultTemplateService(requestHandler: RequestHandler) : RestService(requestHandler) {
     ...
     */
    suspend fun createGuildFromTemplate(code: String, request: GuildFromTemplateCreateRequest): DiscordGuild =
     ...
     */
    suspend fun createGuildTemplate(guildId: Snowflake, request: GuildTemplateCreateRequest) =
    ...
    suspend fun modifyGuildTemplate(guildId: Snowflake, code: String, request: GuildTemplateModifyRequest) =
        call(Route.TemplatePatch) {
            keys[Route.GuildId] = guildId
            keys[Route.TemplateCode] = code
